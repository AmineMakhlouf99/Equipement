$(function () {
    ...
    for (i = 0; i < countryInput.length; i++) {
        ...
        if (flag) {
            countryList = " <option  value='' >Choisir pays  </option>";
            
            //for each build list with flag
            $.each(countries, function (index, country) {

             // var flagIcon = '../bundles/testsite/css/flags/'+ country.code + '.png';

                var flagIcon = 'https://candidature.flodo.fr/candidatures-spontanees/bundles/testsite/images/flags/'+ country.code + '.png';

                countryList += "<option data-country-code='" + country.code + "' data-tokens='" + country.code + " " + country.name + "' style='padding-left:25px; background-position: 4px 7px; background-image:url("+ flagIcon + ");background-repeat:no-repeat;' value='" + country.name + "'><img src='"+flagIcon+"'/>" + country.name + "</option>";
            ...
            countryInput.eq(i).on('loaded.bs.select', function (e) {
               ...
               // var flagIcon = '../bundles/testsite/css/flags/'+ def + '.png';

                var flagIcon = 'http://candidature.flodo.fr/candidatures-spontanees/bundles/testsite/images/flags/'+ def + '.png';
               ...
               // button.css("background-image", "url('../css/flags/az.png')");
            ...
            countryInput.eq(i).on('change', function () {
                ...
                // flagIcon = '../bundles/testsite/css/flags/'+ def + '.png';
                var flagIcon = 'https://candidature.flodo.fr/candidatures-spontanees/bundles/testsite/images/flags/'+ def + '.png';
